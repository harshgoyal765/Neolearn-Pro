...
//   const [ role , setRole ] = useState(userData.description || "")
...
//           {/* Avatar Input */}
//           <div>
//             <label htmlFor="image" className="text-sm text-gray-700 font-semibold mb-2">
//               Select Avatar
//             </label>
//             <input
//               id='image'
...
//           <button
//             type="submit"
//             className="w-full py-4 bg-black text-white rounded-xl font-semibold hover:bg-gray-800 transition-colors resize-none"
